...
<Steps>
  <Step title="Create a Unipile account">
    ...
    <img style={{width:"60%"}} src="/images/providers/linkedin/step-1-signup.png" alt="Create Unipile account" />
  </Step>
  ...
  <Step title="Get your API Key and DSN">
    ...
    <img style={{width:"60%"}} src="/images/providers/linkedin/step-2-api-key.png" alt="Copy Unipile API Key and DSN" />
  </Step>
  ...
  <Step title="Connect your LinkedIn account in Unipile">
    ...
    <img style={{width:"60%"}} src="/images/providers/linkedin/step-4-connect-account.png" alt="Connect LinkedIn in Unipile" />
  </Step>
  ...
  <Step title="Register the Connections webhook">
    ...
    <img style={{width:"60%"}} src="/images/providers/linkedin/step-5-connections-webhook.png" alt="Register connections webhook" />
  </Step>
  ...
  <Step title="Register the Messages webhook">
    ...
    <img style={{width:"60%"}} src="/images/providers/linkedin/step-6-messages-webhook.png" alt="Register messages webhook" />
  </Step>
</Steps>
