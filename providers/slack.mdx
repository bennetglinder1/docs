...
<Steps>
  <Step title="Create a Slack app">
    ...
    <img width="60%" src="/images/providers/slack/step-1-create-app.png" alt="Create a new Slack app" />
  </Step>
  ...
  <Step title="Add OAuth scopes">
    ...
    <img width="60%" src="/images/providers/slack/step-2-scopes.png" alt="Add OAuth scopes" />
  </Step>
  ...
  <Step title="Set the redirect URI">
    ...
    <img width="60%" src="/images/providers/slack/step-3-redirect-uri.png" alt="Set redirect URI" />
  </Step>
  ...
  <Step title="Copy Client ID and Client Secret">
    ...
    <img width="60%" src="/images/providers/slack/step-4-credentials.png" alt="Copy Client ID and Client Secret" />
  </Step>
...
<img width="60%" src="/images/providers/slack/connect-ui.png" alt="Connect Slack in Proply UI" />
