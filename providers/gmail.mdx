...
<Steps>
  <Step title="Create a Google Cloud project">
    ...
    <img style={{width:"60%"}} src="/images/providers/gmail/step-1-create-project.png" alt="Create Google Cloud project" />
  </Step>
  ...
  <Step title="Enable Gmail API and Google Calendar API">
    ...
    <img style={{width:"60%"}} src="/images/providers/gmail/step-2-enable-apis.png" alt="Enable Gmail and Calendar APIs" />
  </Step>
  ...
  <Step title="Configure the OAuth consent screen">
    ...
    <img style={{width:"60%"}} src="/images/providers/gmail/step-3-consent-screen.png" alt="OAuth consent screen setup" />
  </Step>
  ...
  <Step title="Create OAuth credentials">
    ...
    <img style={{width:"60%"}} src="/images/providers/gmail/step-4-create-credentials.png" alt="Create OAuth credentials" />
  </Step>

  <Step title="Copy your Client ID and Secret">
    After creating, copy the **Client ID** and **Client Secret**.

    <img style={{width:"60%"}} src="/images/providers/gmail/step-5-copy-credentials.png" alt="Copy Client ID and Client Secret" />
  </Step>
...
<img style={{width:"60%"}} src="/images/providers/gmail/connect-ui.png" alt="Connect Gmail in Proply UI" />
